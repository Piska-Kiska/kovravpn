...
const en: Dict = {
  ...
  total_now: "Total now",
  renews_note: "One-time crypto payment. No auto-renewal.",
...
const ru: Dict = {
  ...
  total_now: "К оплате",
  renews_note: "Разовый платёж криптой. Без автопродления.",
...
const es: Dict = {
  ...
  renews_note: "Pago único con cripto. Sin renovación automática.",
...
const de: Dict = {
  ...
  renews_note: "Einmalige Krypto-Zahlung. Keine automatische Verlängerung.",
...
const fr: Dict = {
  ...
  renews_note: "Paiement crypto unique. Pas de renouvellement automatique.",
