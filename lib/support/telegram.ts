...
export function createForumTopic(chatId: number, name: string) {
  return call<{ message_thread_id: number; name: string }>('createForumTopic', {
    chat_id: chatId,
    name,
  });
}

export function closeForumTopic(chatId: number, messageThreadId: number) {
  return call<boolean>('closeForumTopic', {
    chat_id: chatId,
